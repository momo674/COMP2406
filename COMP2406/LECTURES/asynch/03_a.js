...
function read() {
  setTimeout(function(){console.log("read"); callback();},
             Math.floor((Math.random() * 1000) + 1))
}

function process() {
  setTimeout(function(){console.log("process");  callback();},
             Math.floor((Math.random() * 1000) + 1))
}

function output() {
  setTimeout(function(){console.log("output");  callback();},
             Math.floor((Math.random() * 1000) + 1))
}


const x = 7; console.log(x);
read()
process()
output()
